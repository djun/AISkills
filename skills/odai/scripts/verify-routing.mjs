...
const mappings = new Map([["odai_planner", "planner"], ["odai_executor", "executor"], ["odai_reviewer", "reviewer"]]);

if (args.help) {
  console.log(`Usage:
  node odai-verify-routing.mjs --host codex --project <directory> \\
    --role <odai_planner|odai_executor|odai_reviewer> --after <ISO timestamp> \\
...
if (!mappings.has(args.role)) fail("--role 必须是 odai_planner、odai_executor 或 odai_reviewer");
