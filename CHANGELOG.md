...
- GPT-5.6-sol / high、Claude Opus 5 与 Grok 4.5 全量 on 均为 136/136；Gemini 3.6 Flash / high 为 119/136，Kimi K3 为 122/136。
- 配对 A/B on / off 与净增分别为：GPT 88/88 / 74/88（+14）、Opus 88/88 / 71/88（+17）、Grok 88/88 / 67/88（+21）、Gemini 77/88 / 54/88（+23）、K3 80/88 / 73/88（+7）；同步保留 runner token 成本对比。
