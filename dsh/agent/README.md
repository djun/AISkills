...
The installer checks `dsh -V` and currently accepts exactly `0.1.1-rc.2`; `0.2.11` rejects rc.7, rc.1, and every other developer-preview release. It records the detected version in the managed manifest and installs the rc.2 Standard composition directly.
