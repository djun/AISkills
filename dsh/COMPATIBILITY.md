...
| --- | --- | --- | --- |
| `0.2.6` | `0.2.6` | `0.1.0-rc.7`、`0.1.1-rc.1`、`0.1.1-rc.2` | 当前候选版本；DSH Runtime、Plugin、Agent、测试与发布工具完整 strict TypeScript 迁移，职责拆分与 0.1.1 兼容 |
...
2. “支持的 DSH”是精确白名单。例如 `0.2.6` 不支持 rc.6，也不自动承诺兼容当前白名单之外的 `0.1.1-rc.3`。
