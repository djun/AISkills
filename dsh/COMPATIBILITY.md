...
| --- | --- | --- | --- |
| `0.2.7` | `0.2.7` | `0.1.0-rc.7`、`0.1.1-rc.1`、`0.1.1-rc.2` | 当前候选版本；修正 Planner/Reviewer 责任路由、原生证据与三版本发布 gate |
...
2. “支持的 DSH”是精确白名单。例如 `0.2.7` 不支持 rc.6，也不自动承诺兼容当前白名单之外的 `0.1.1-rc.3`。
