...
The package accepts exactly `@deepseek-ai/dsh@0.1.1-rc.2`; `0.2.12` rejects every other developer-preview release, and each future release requires isolated real-load verification before this exact peer contract changes.
