...
The package accepts exactly `@deepseek-ai/dsh@0.1.0-rc.7` or `0.1.0-rc.8`; `0.2.5` no longer supports rc.6, and DSH remains a developer preview, so every added release requires isolated real-load verification before this range expands.
